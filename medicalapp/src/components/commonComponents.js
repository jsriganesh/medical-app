...
//     const  [parentQuestionDetails,setParentQuestion]= useState({})

//     return (
//         <TouchableOpacity style={styles.buttonStyle} onPress={() => {

//             if (allQuestions[index + 1].validation && allQuestions[index + 1].validation.length > 0) {
//                 // console.log("Current question ************** > "+JSON.stringify(allQuestions[index ]))

//                 // console.log("Next question **************  > "+JSON.stringify(allQuestions[index + 1]))
//                 if (allQuestions[index + 1].validation.length > 1) {
//                     console.log("val length is  > "+allQuestions[index + 1].validation.length)
//                     console.log("parentQuestionDetails is  > "+JSON.stringify(parentQuestionDetails))
...
//                                 // &&
//                                 parentQuestionDetails.parentQuestionNo == allQuestions[checIndex].validation[0].parentQuestionNo
//                                 &&
//                                 parentQuestionDetails.questionNo == allQuestions[checIndex].validation[0].questionNo
//                                 &&
//                                 parentQuestionDetails.answer.length > 0
//                                 &&
//                                 parentQuestionDetails.answer[0].option == allQuestions[checIndex].validation[0].value) ||
//                             (
//                                 // allQuestions[checIndex] && allQuestions[checIndex].validation && allQuestions[checIndex].validation.length > 0
//                                 // &&
//                                 parentQuestionDetails.parentQuestionNo == allQuestions[checIndex].validation[1].parentQuestionNo
//                                 &&
//                                 parentQuestionDetails.questionNo == allQuestions[checIndex].validation[1].questionNo
//                                 &&
//                                 parentQuestionDetails.answer.length > 0
//                                 &&
//                                 parentQuestionDetails.answer[0].option == allQuestions[checIndex].validation[1].value)
//                         ) {
