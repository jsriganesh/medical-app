...
export const CommonButton = ({ label, callBack }) => {
 ...
 const isDeviceWidth360_374 = useMediaQuery({
    ...
    return (
        <TouchableOpacity style={[styles.buttonStyle,{width:isDeviceWidth360_374 ? "100%" : isDeviceWidth375_811 ? 300 : 300, }]} onPress={() => {
            callBack()
        }}>
...
export const RenderTextBoxWithIcon = ({ image, placeholder, value, callBack,type }) => {
 ...
 const isDeviceWidth360_374 = useMediaQuery({
    ...
    return (
        <View style={[styles.componentContainer,{width:isDeviceWidth360_374 ? "100%" : isDeviceWidth375_811 ? 300 : 300, }]}>
